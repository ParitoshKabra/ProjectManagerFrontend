...
function CreateProject(props) {
	...
	const handleSubmit = (e) => {
		...
		if (!props.edit) {
			...
			props.axiosInstance
				.put('http://127.0.0.1:8000/trelloAPIs/projects/' + props.project.id + '/', data, {
					headers: {
						'X-CSRFToken': cookies.get('csrftoken'),
						'Content-Type': 'application/json',
						'X-Requested-With': 'XMLHttpRequest'
	...
	const handleDelete = () => {
		setOpen(false);
		props.axiosInstance
			.delete('http://127.0.0.1:8000/trelloAPIs/projects/' + props.project.id + '/', {
		...
		return (
			...
			>
				...
				<Container component="div" className={classes.container}>
					...
					{props.edit ? <Button color="secondary" variant="contained" type="submit" onClick={(e) => {
						e.preventDefault();
						setOpen(true);
					}}>
						<DeleteIcon />
				...
				>
					...
					<DialogContent>
						<DialogContentText id="alert-dialog-description">
							...
							All it's lists and cards and progress will be lost!!
						</DialogContentText>
					</DialogContent>
					<DialogActions>
						<Button onClick={() => { setOpen(false) }} variant="contained" color="primary">No</Button>
						<Button onClick={handleDelete} autoFocus variant="contained" color="secondary">
